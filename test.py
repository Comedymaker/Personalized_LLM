...
model = AutoModelForCausalLM.from_pretrained(model_id_final).to(device)
...
predicted_text = tokenizer.decode(torch.argmax(first_sample_logits, dim=-1)[0], skip_special_tokens=True)
